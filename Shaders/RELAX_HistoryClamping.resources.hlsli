...
NRD_INPUTS_START
    ...
    NRD_INPUT( Texture2D, float, gIn_HistoryLength, t, 2 )
        ...
        NRD_INPUT( Texture2D, float4, gIn_DiffFast, t, 8 )
            ...
            NRD_INPUT( Texture2D, RELAX_SH_TYPE, gIn_SpecShFast, t, 11 )
            NRD_INPUT( Texture2D, RELAX_SH_TYPE, gIn_DiffShFast, t, 12 )
        #endif
    #elif( NRD_HAS_DIFF )
        ...
        NRD_INPUT( Texture2D, float4, gIn_DiffFast, t, 5 )
            ...
            NRD_INPUT( Texture2D, RELAX_SH_TYPE, gIn_DiffShFast, t, 7 )
        #endif
    #else
        NRD_INPUT( Texture2D, float4, gIn_SpecNoisy, t, 3 )
        ...
        #if( NRD_MODE == NRD_MODE_SH )
            NRD_INPUT( Texture2D, RELAX_SH_TYPE, gIn_SpecSh, t, 6 )
            NRD_INPUT( Texture2D, RELAX_SH_TYPE, gIn_SpecShFast, t, 7 )
        #endif
    #endif
NRD_INPUTS_END
...
NRD_OUTPUTS_START
    NRD_OUTPUT( RWTexture2D, float, gOut_HistoryLength, u, 0 )
        ...
        NRD_OUTPUT( RWTexture2D, float4, gOut_DiffFast, u, 4 )
            ...
            NRD_OUTPUT( RWTexture2D, RELAX_SH_TYPE, gOut_SpecShFast, u, 7 )
            NRD_OUTPUT( RWTexture2D, RELAX_SH_TYPE, gOut_DiffShFast, u, 8 )
        #endif
    #elif( NRD_HAS_DIFF )
        ...
        NRD_OUTPUT( RWTexture2D, float4, gOut_SpecFast, u, 2 )
            ...
            NRD_OUTPUT( RWTexture2D, RELAX_SH_TYPE, gOut_SpecShFast, u, 4 )
        #endif
    #endif
NRD_OUTPUTS_END
